...
| **PackageIndex** | Publish **or** read/discover a package index | 9 — 5 write (apt, opkg, pacman, apk, rpm) + 4 read (lx-community, aur, repology, custom) | `lx repo --format` / `indexes.yaml` |
